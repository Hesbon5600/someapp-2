"""
Django settings for someapp_2 project.
...
WSGI_APPLICATION = 'someapp_2.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "someapp_2 API",
    "DESCRIPTION": "API documentation for someapp_2 App",
    "VERSION": "v1",
}
